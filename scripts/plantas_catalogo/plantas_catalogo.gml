...
function plantas_criar_catalogo()
{
    return {
        ...
        girassol:           { objeto: obj_girassol,           card: obj_card_girassol,           custo: 50,  recarga: 7.5,  desbloqueada_inicial: true },
        noz:                { objeto: obj_noz_obstaculo,      card: obj_card_noz,                custo: 50,  recarga: 15.0, desbloqueada_inicial: true },
        ervaespinho:        { objeto: obj_ervaespinho,        card: obj_card_ervaespinho,        custo: 100, recarga: 7.5,  desbloqueada_inicial: true },
        batatamina:         { objeto: obj_batatamina,         card: obj_card_batatamina,         custo: 25,  recarga: 20.0, desbloqueada_inicial: true },
        esparabalde:        { objeto: obj_esparabalde,        card: obj_card_esparabalde,        custo: 75,  recarga: 15.0, desbloqueada_inicial: true },
        repelecao:          { objeto: obj_repele_cao,         card: obj_card_repelecao,          custo: 75,  recarga: 15.0, desbloqueada_inicial: true },
        duplervilha:        { objeto: obj_duplervilha,        card: obj_card_duplervilha,        custo: 175, recarga: 10.0, desbloqueada_inicial: true },
