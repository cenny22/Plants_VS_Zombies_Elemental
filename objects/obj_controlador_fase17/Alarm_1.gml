...
if (qtd_quadrados > 0) {
    ...
    if (zumbis_nascidos >= total_fase) {
        zumbi_para_criar = obj_zumbi_gorila;
        tempo_min = 2;
        tempo_max = 4;
        ...
        else if (chance < 65) zumbi_para_criar = obj_zumbi_gorila;
        else if (chance < 85) zumbi_para_criar = obj_zumbi_gorila;
        else zumbi_para_criar = obj_zumbi_tarzan;
    } else if (zumbis_nascidos >= 5 || global.zumbis_mortos >= 5) {
        tempo_min = 2;
        tempo_max = 4;
        var chance = irandom(99);
        if (chance < 50) zumbi_para_criar = obj_zumbi_indigena;
        else if (chance < 80) zumbi_para_criar = obj_zumbi_gorila;
        else zumbi_para_criar = obj_zumbi_cone;
    } else {
        tempo_min = 12;
        tempo_max = 16;
