...
if (tipo_limpo == "disparervilha" || tipo_limpo == "ervilha" || tipo_limpo == "disparaervilha") {
    nome_objeto = "obj_disparaervilha";
}
...
else if (tipo_limpo == "broto") {
    nome_objeto = "obj_brotoflorescedor";
}
...
if (object_exists(obj_index)) {
    ...
    show_debug_message("ERRO: Objeto nao encontrado para o tipo: " + string(planta_tipo) + " | Tentou buscar: " + nome_objeto);
}